...
def predict_np(str_array: list) -> int:
    ...
    return predict(str_array, '/home/egore/proj/cc/nlp_np.h5', '/home/egore/proj/cc/tokenizer_np.pkl')


text = ['Ужасный вебинар', 'Великолепный курс']
class_np = predict_np(text)
print(class_np)
